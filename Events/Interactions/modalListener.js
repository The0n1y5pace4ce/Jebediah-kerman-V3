...
module.exports = {
  name: "interactionCreate",
    ...
    if (modal.developer && interaction.user.id !== "656306365534437386") return interaction.reply({ embeds: [ new EmbedBuilder().setDescription( `⛔ | This modal is for developers only.`).setColor("#f8312f") ], ephemeral: true });
